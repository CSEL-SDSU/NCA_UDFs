...
;;; Gravity: GX=${GX}, GY=${GY}
;;; Gap Height: H=${H}
;;; Opposed flow velocity: U=${U}
;;; Max iterations: NITER=${NITER}
...
(rp-var-define 'user/u_mean ${U} 'real #f)
...
yes yes \
 ...
 enthalpy enthalpy-co2 enthalpy-h2o enthalpy-n2 enthalpy-o2 enthalpy-c5o2h8 sensible-enthalpy \
 heat-of-reaction net-rate-c5o2h8 net-rate-co2 net-rate-h2o net-rate-n2 net-rate-o2 face-radiation \
 surf-incident-radiation ()
...
/report/fluxes/heat-transfer-sensible yes no
/report/fluxes/rad-heat-transfer yes no
